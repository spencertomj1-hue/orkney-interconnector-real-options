# see docs/notes/Extra/orkney_link_opex.md#two-independent-opex-estimation-methods
...
# see docs/notes/Extra/orkney_link_opex.md#per-cable-capacity-split-assumption
...
# see docs/notes/Extra/orkney_link_opex.md#fault-provision-placeholder-rationale
